...
class Text_FM(nn.Module):
    def __init__(self, args, data):
        ...
        self.text_embedding1 = nn.Linear(args.word_dim, args.embed_dim)
        self.text_embedding2 = nn.Linear(args.word_dim, args.embed_dim)
    ...
    def forward(self, x):
        ...
        # text to dense
        user_text_feature = self.text_embedding1(user_text_vector)  # (batch_size, embed_dim)
        user_text_feature = user_text_feature.view(-1, 1, user_text_feature.size(1))  # (batch_size, 1, embed_dim)
        item_text_feature = self.text_embedding2(book_text_vector)  # (batch_size, embed_dim)
